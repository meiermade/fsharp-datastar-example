module App.SimpleAccount.View

open App.Common.View
open App.SimpleAccount.Model
...
let accountPage (model:Model) =
    ...
    Page.primary(
        attrs=[
            _data ("on:deposit-changed", "$amount = evt.detail.amount; $date = evt.detail.date; @post(`/simple-account/deposit`)")
            _data ("on:withdrawal-changed", "$amount = evt.detail.amount; $date = evt.detail.date; @post(`/simple-account/withdrawal`)")
        ],
        content=[
            h1 [
            ...
            div [
                ...
                _children [
                    ...
                    input [
                        _class "input"
                        _type "number"
                        _data ("on:change", "@post('/simple-account/apy')")
                        _data ("bind", "apy")
                            ...
                            tbody [
                                _children [
                                    ...
                                    tr [
                                        _children [
                                            ...
                                            for date in dates do
                                                ...
                                                let balance' = model.account.balance[date]
                                    ...
                                    tr [
                                        _children [
                                            th [
                                                _class "sticky left-0 bg-white z-10 whitespace-nowrap"
                                                _children "Yield Accrued"
                                            ]
                                            for date in dates do
                                                let yieldAccrued = !!model.account.yieldAccrued[date]
                                                td [
                                                    _children [
                                                        span [
                                    ...
                                    tr [
                                        _children [
                                            th [
                                                _class "sticky left-0 bg-white z-10 whitespace-nowrap"
                                                _children "Yield Received"
                                            ]
                                            for date in dates do
                                                let yieldReceived = !!model.account.yieldReceived[date]
                                                td [
                                                    _children [
                                                        span [
                                                            _class "input bg-gray-100"
                                                            _children (yieldReceived.ToString("C"))
                                                        ]
                                                    ]
                                                ]
                                        ]
                                    ...
                                    tr [
                                        _children [
                                            th [
                                                ...
                                                _children "Yield Balance"
                                            ]
                                            for date in dates do
                                                let amount = !!model.account.yieldBalance[date]
                                                td [
                                                    _class "border-t-2 border-gray-300"
                                                    _children [
                                                        span [
                                                            _class "input bg-gray-100"
                                                            _children (amount.ToString("C"))
                                                        ]
                                                    ]
                                                ]
                                        ]
                                    ...
                                    tr [
                                        _children [
                                            ...
                                            for date in dates do
                                                let amount = !!model.account.balance[date]
                                                td [
                                                    _children [
                                                        span [
                                                            _class "input bg-gray-100"
